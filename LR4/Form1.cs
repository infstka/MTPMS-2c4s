...
namespace ЛР2
{
    public partial class Form1 : Form
    {
        ...
        List<Discipline> deletedDisciplines = new List<Discipline>();
        private void next_Click(object sender, EventArgs e)
        {
            disciplines.Items.Add(deletedDisciplines.First().ToString());
            deletedDisciplines.RemoveAt(deletedDisciplines.Count - 1);
        }

        private void back_Click(object sender, EventArgs e)
        {
            deletedDisciplines.Add(uchebnyotdel.Disciplines.Last()) ;
